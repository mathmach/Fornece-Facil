            ...
            <form>
                ...
                <div class="section_room">
                    <select id="country" onchange="change_country(this.value)" class="frm-field required">
                        ...
                        <option value="null">Eletrônicos</option>     
                    </select>
                </div>
                <div class="sear-sub">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            <li class="active menu__item ${pageContext.request.requestURI eq '/FAITEC/pages/index.jsp' ? ' menu__item--current' : ''}"><a class="menu__link" href="index.jsp">Início <span class="sr-only">(current)</span></a></li>
                            <li class=" menu__item ${pageContext.request.requestURI eq '/FAITEC/pages/eletronics.jsp' ? ' menu__item--current' : ''}"><a class="menu__link" href="electronics.jsp">Eletônicos</a></li>
