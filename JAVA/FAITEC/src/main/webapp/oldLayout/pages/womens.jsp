...
<html>
    <head>
        ...
        <jsp:include page="../layout/header.jsp" flush="true">
            <jsp:param name="title" value="Projeto X | Womens"/>
        </jsp:include>
    </head>
    <body>        
                ...
                <div class="col-md-8 products-right">
                    ...
                    <div class="men-wear-top">
                        <div  id="top" class="callbacks_container">
                            <ul class="rslides" id="slider3">
                                <li>
                                    <img class="img-responsive" src="../img/men21.jpg" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="../img/men11.jpg" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="../img/men21.jpg" alt=" "/>
                                </li>
                    ...
                    <div class="men-wear-bottom">
                        <div class="col-sm-4 men-wear-left">
                            <img class="img-responsive" src="../img/men31.jpg" alt=" " />
                        </div>
