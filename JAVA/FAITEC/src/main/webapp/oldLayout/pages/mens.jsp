...
<html>
    <head>
        ...
        <jsp:include page="../layout/header.jsp" flush="true">
            <jsp:param name="title" value="Projeto X | Mens"/>
        </jsp:include>
        <link rel="stylesheet" type="text/css" href="../includes/vendors/jquery-ui-1.12.1/jquery-ui.min.css">
    </head>
    <body>        
                ...
                <div class="col-md-8 products-right">
                    ...
                    <div class="men-wear-top">
                        <div  id="top" class="callbacks_container">
                            <ul class="rslides" id="slider3">
                                <li>
                                    <img class="img-responsive" src="../img/men1.jpg" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="../img/men2.jpg" alt=" "/>
                                </li>
                                <li>
                                    <img class="img-responsive" src="../img/men1.jpg" alt=" "/>
                                </li>
                    ...
                    <div class="men-wear-bottom">
                        <div class="col-sm-4 men-wear-left">
                            <img class="img-responsive" src="../img/men3.jpg" alt=" " />
                        </div>
        ...
        <!---->
        <script src="../includes/vendors/responsiveslides/responsiveslides.min.js"></script>
        <script>
